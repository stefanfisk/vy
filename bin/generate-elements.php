...
/** @var array<non-empty-string,class-string<BaseElement>> $htmlTagNameToElementClass */
$htmlTagNameToElementClass = [
    'a' => Element::class,
    'abbr' => Element::class,
...
/** @var array<non-empty-string,class-string<BaseElement>> $svgTagNameToElementClass */
$svgTagNameToElementClass = [
    'a' => Element::class,
    'animate' => Element::class,
    'animateMotion' => Element::class,
    'animateTransform' => Element::class,
    'circle' => Element::class,
    ...
    'polygon' => Element::class,
    'polyline' => Element::class,
...
$namespaceToTagNameToElementClass = [
    'Html' => $htmlTagNameToElementClass,
    'Svg' => $svgTagNameToElementClass,
];
...
foreach ($namespaceToTagNameToElementClass as $namespace => $tagNameToElementClass) {
    foreach ($tagNameToElementClass as $tagName => $elementClass) {
        $elementClassImport = substr(strrchr($elementClass, '\\'), 1);
        ...
        $src .= "        mixed ...\$props,\n";
        $src .= "    ): $elementClassImport {\n";
        $src .= "        if (\$class !== null) {\n";
        $src .= "            \$props['class'] = \$class;\n";
        $src .= "        }\n";
        $src .= "\n";
        $src .= "        return new $elementClassImport(\n";
        $src .= "            key: \$_key,\n";
        $src .= "            type: '$tagName',\n";
        $src .= "            props: \$props,\n";
        $src .= "        );\n";
